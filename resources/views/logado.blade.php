...
<head>
    ...
    <link href="css/logado1.css" rel="stylesheet" type="text/css"/>
   ...
   <header>
    ...
    <div class="container">
            ...
            <div class="col-lg-12">
                <h1 class="page-header">Descrição da Carona        
                    <div class=text-right>
                      <a href="carona.php" <span class="glyphicon glyphicon-road"></span></a>
                    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <h3 class="page-header">Ultimas Caronas</h3>
            </div>
