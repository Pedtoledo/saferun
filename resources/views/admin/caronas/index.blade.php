    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top navbar-custom">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              ...
              <form class="navbar-form navbar-left" method="POST" action="{{ route('admpesquisa')}}">
                 {{csrf_field()}}
     ...
     <div class="col-lg-6">
       <table class="table table-hover">
                                ...
                                <td>
                                         ...
                                         <button type="button" class="btn btn-danger " data-toggle="modal" data-target="#myModal{{$carona->id}}">
  Excluir
</button>

<div class="modal fade" id="myModal{{$carona->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
