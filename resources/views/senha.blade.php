...
<head>
    ...
    <link href="css/leosenha.css" rel="stylesheet" type="text/css"/>
    <!-- Custom Fonts -->
     ...
     <div class="form-group ">
       ...
       Email:
        ...
        Nome:
             ...
             <input class="form-control" id="nme" name="Nome" placeholder="Nome" type="text" required/> 
             <br>
          <div class="g-recaptcha" data-sitekey="6Lc-DCQUAAAAAGY6aZgTc24ssoOXDBHFpWTpYT_U"></div>
             <br>
              <input <a class="btn btn-md btn-primary" type="submit" value="Recuperar">
