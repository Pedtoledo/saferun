...
<div class="row" >
    <a href="/caronas/create"><button type="submit"  class="btn btn-primary">Cadastrar carona</button></a>
</div>
...
@foreach ($caronas as $carona)
  ...
  <div class="col-md-4" style="margin-bottom: 5%;">
    <h4>{{$carona->nome}}</h4>
    <img class="img-responsive" src="{{asset('/imagescaronas')}}/{{$carona->image}}" alt="">
